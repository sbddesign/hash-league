    ...
    <header className="fixed top-0 left-0 right-0 z-30 bg-black bg-opacity-70 backdrop-blur-sm border-b border-[#00f3ff] px-4 py-3 flex justify-between items-center">
      <div className="flex items-center">
        ...
        <button 
          ...
          className="ml-4 flex items-center px-3 py-1.5 rounded bg-green-900 bg-opacity-50 border border-green-500 text-green-500 hover:bg-opacity-70 text-sm transition"
        >
