...
export default function AddPoolButton() {
  ...
  return (
    <Button
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-30 bg-[#39FF14] text-black font-bold px-4 py-6 rounded-full flex items-center hover:bg-opacity-90 transition-all transform hover:scale-105"
    >
