...
export const faqData: FaqItem[] = [
  ...
  {
    question: "Where can I find the source code or contribute?",
    answer: "Find us on github: https://github.com/sbddesign/hash-league/",
  },
  {
    question: "What does it mean to share my hash rate to a mining pool?",
    answer:
      "Sharing your mining device's computational power with a mining pool means contributing your device's hash calculations that it can perform per second to find a valid block in order to work together to solve for a Bitcoin block and earn a reward.",
  },
  {
    question: "Can I participate in Hash League independent of a meetup?",
    answer:
      "Yes you can set up your own mining operation, for example using a BitAxe, and you can point your hash rate to any of the available public pools to participate.",
  },
  {
    question:
      "How can I participate in a public pool without doxing my information?",
...
Use fresh Bitcoin addresses (preferably with coin control and mixing via tools like Whirlpool or CoinJoin) to reduce linkage between your hashrate and your on-chain identity.`,
  ...
  {
    question:
      "If a block reward is won, will I receive the full block coinbase or will it be shared with the pool that I am participating in?",
    answer:
      "This will be determined by the public pool you joined. Please check closely the payment payout rules prior to joining any public pool.",
  },
  {
    question:
      "Can you configure the miner to receive the block reward payment independent of the pool owner? (i.e not making the pool owner a custodian of the reward)",
...
There is a P2P pool that does payouts on a coinbase using atomic swaps over lightning refer Blog for more information`,
  ...
  {
    question:
      "I'm a meetup organizer, How do I quickly setup my own pool for my meetup?",
    answer: `We recommend one of the following options:
Umbrel - https://community.umbrel.com/t/public-pool-set-up/15495
Manual Setup - https://github.com/benjamin-wilson/public-pool/tree/master/full-setup`,
  },
];
